...
<%@page import="com.egresados2016.modelo.Escuela"%>
<%@page import="com.egresados2016.dao.interfaces.EscuelaDAO"%>
<%@page import="com.egresados2016.dao.factory.EscuelaDAOFactory"%>
...
<%@page import="com.egresados2016.dao.interfaces.EgresadoDAO"%>
<%@page import="com.egresados2016.dao.factory.EgresadoDAOFactory"%>
<%@page import="com.egresados2016.modelo.Egresado"%>
...
<html>
    ...
    <%
        EgresadoDAOFactory fabricate1 = new EgresadoDAOFactory();
        EgresadoDAO daote1 = fabricate1.metodoDAO();
        Egresado objE = new Egresado();
        objE.setIdEgresado(Integer.parseInt(request.getParameter("idEgresado")));
        int idEgresado = objE.getIdEgresado();
        Egresado egre = daote1.leerxid(objE);
...
EscuelaDAOFactory fabricate7 = new EscuelaDAOFactory();
        EscuelaDAO daote7 = fabricate7.metodoDAO();
        Escuela[] escu = daote7.leertodo();
    ...
    <body class="nav-sm">
        ...
        <div class="container body">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                            ...
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                ...
                                                <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Grados</a>
                                                </li>
                                                <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab3" data-toggle="tab" aria-expanded="false">Datos Laborales</a>
                                                </li>
                                                <li role="presentation" class=""><a href="#tab_content4" role="tab" id="profile-tab4" data-toggle="tab" aria-expanded="false">Estudios</a>
                                                </li>
                                                <li role="presentation" class=""><a href="#tab_content5" role="tab" id="profile-tab5" data-toggle="tab" aria-expanded="false">Encuesta</a>
                                                </li>
                                            </ul>
                                            ...
                                            <div id="myTabContent" class="tab-content">
                                                                ...
                                                                <form class="form-horizontal form-label-left" id="crearform" enctype="multipart/form-data">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-3 col-sm-3 col-xs-3">
                                                                            <input type="text" id="idEgresado1" name="idEgresado1" class="form-control" readonly="readonly"  value="<%=idEgresado%>">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                                            <select name="departamentoNa" id="SelectDepaNa" class="form-control">
                                                                                ...
                                                                                <option value="<%=depa1.getIdDepartamento()%>"
                                                                                        <%if (egre.getDistritoNacimiento().getProvincia().getDepartamento().getIdDepartamento() == depa1.getIdDepartamento()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %>
                                                                                        >
                                                                        ...
                                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                                            <select  name="provinciaNa" id="SelectProNa" class="select2_group form-control">
                                                                                ...
                                                                                %>
                                                                                <option value="<%=provi1.getIdProvincia()%>"
                                                                                        <%if (egre.getDistritoNacimiento().getProvincia().getIdProvincia() == provi1.getIdProvincia()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %>
                                                                                        >
                                                                                    <%=provi1.getDescripcion()%></option>
                                                                                    <%}%>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                                            <select name="distritoNa" id="SelectDisNa" class="select2_group form-control">
                                                                                ...
                                                                                <%for (Distrito dis1 : dis) {

                                                                                %>
                                                                                <option value="<%=dis1.getIdDistrito()%>"
                                                                                        <%if (egre.getDistritoNacimiento().getIdDistrito() == dis1.getIdDistrito()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %>
                                                                                        >
                                                                                    <%=dis1.getDescripcion()%></option>
                                                                                    <%}%>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                                            <select name="departamentoRe" id="SelectDepaRe" class="form-control">
                                                                                ...
                                                                                %>
                                                                                <option value="<%=depa1.getIdDepartamento()%>"
                                                                                        <%if (egre.getDistritoResidencia().getProvincia().getDepartamento().getIdDepartamento() == depa1.getIdDepartamento()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %> 
                                                                                        >
                                                                        ...
                                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                                            <select name="provinciaRe" id="SelectProRe"  class="select2_group form-control">
                                                                                ...
                                                                                %>
                                                                                <option value="<%=provi1.getIdProvincia()%>"
                                                                                        <%if (egre.getDistritoResidencia().getProvincia().getIdProvincia() == provi1.getIdProvincia()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %>
                                                                                        >
                                                                        ...
                                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                                            <select name="distritoRe" id="SelectDisRe" class="select2_group form-control">
                                                                                ...
                                                                                %>
                                                                                <option value="<%=dis1.getIdDistrito()%>"
                                                                                        <%if (egre.getDistritoResidencia().getIdDistrito() == dis1.getIdDistrito()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %>
                                                                                        >
                                                                        ...
                                                                        <div class="col-md-3 col-sm-6 col-xs-6">
                                                                            <select name="facultad" id="SelectFacultad1" class="form-control">
                                                                                <option value="--">Facultad</option>
                                                                                <%for (Facultad facu1 : facu) {

                                                                                %>
                                                                                <option value="<%=facu1.getIdFacultad()%>"
                                                                                                 <%if (egre.getEscuela().getFacultad().getIdFacultad()  == facu1.getIdFacultad()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %>
                                                                                        >
                                                                        ...
                                                                        <div class="col-md-3col-sm-6 col-xs-6">
                                                                            <select  name="escuela" id="SelectEscuela1" class=" form-control">
                                                                                <option value="--">Escuela</option>
                                                                                <%for (Escuela escu1 : escu) {

                                                                                %>
                                                                                <option value="<%=escu1.getIdEscuela() %>"
                                                                                                 <%if (egre.getEscuela().getIdEscuela()  == escu1.getIdEscuela()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %>
                                                                                        >
                                                                                    <%=escu1.getDescripcion()%></option>
                                                                                    <%}%>
                                                                            </select>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="nombres" type="text" class="form-control" value="<%=egre.getNombres()%>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Apellidos</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="apellidos" type="text" class="form-control" value="<%=egre.getApellidos()%>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Fecha de nacimiento</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input  name="fechaNa" type="text" class="form-control has-feedback-left" id="input_fpublicacion" value="<%=egre.getFechaNac()%>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="dni" type="text" class="form-control" value="<%=egre.getDni()%>">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            ...
                                                                            <%} else if (egre.getSexo().name().equals("F")) {%>
                                                                            <div class="radio">
                                                                                <label>
                                                                                    <input type="radio" class="flat" name="sexo" id="genderM" value="M" /> Masculino
                                                                                </label>
                                                                            </div>
                                                                            <div class="radio">
                                                                                <label>
                                                                                    <input type="radio" class="flat" name="sexo" id="genderF" value="F" checked="" required  /> Femenino
                                                                                </label>
                                                                            </div>
                                                                            <%}%>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="direccion" type="text" class="form-control" value="<%=egre.getDireccion()%>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Telefono 1</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="telefono1" type="text" class="form-control" value="<%=egre.getTelefono1()%>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Telefono 2</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name=telefono2 type="text" class="form-control" value="<%=egre.getTelefono2()%>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Correo Electronico</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="email" type="email" class="form-control" value="<%=egre.getCorrero()%>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <select name="anioIngreso"  class="select2_single form-control" tabindex="-1">
                                                                                <option value="<%=egre.getAnioIngreso()%>"><%=egre.getAnioIngreso()%></option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <select name="anioEgreso" class="select2_single form-control" tabindex="-1">
                                                                                <option value="<%=egre.getAnioEgreso()%>"><%=egre.getAnioEgreso()%></option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <select name="nrohijos" class="select2_single form-control" tabindex="-1">
                                                                                ...
                                                                                <option value="<%=egre.getNroHijos()%>"><%=egre.getNroHijos()%></option>
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <select name="estadocivil" class="select2_single form-control" tabindex="-1">
                                                                                ...
                                                                                <option value="<%=es.name()%>" 
                                                                                        <%if (egre.getEstadoCivil().name() == es.name()) {
                                                                                                out.print("selected");
                                                                                            }
                                                                                        %>
                                                        ...
                                                        <div class="x_panel">
                                                            <div class="x_title">
                                                                ...
                                                                <ul class="nav navbar-right panel_toolbox">
                                                                    <li><a class="collapse-link"><i id="bit2" class="fa fa-chevron-down"></i></a>
                                                                    </li>
                                                                </ul>
                                                                <div class="clearfix"></div>
                                                            </div>
                                                            <div class="x_content" id="tab2">
                                                                ...
                                                                <form class="form-horizontal form-label-left " id="crearformtab2" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input type="text" name="idEgresado2" id="idEgresado2" class="form-control" value="<%=idEgresado%>" readonly="readonly" placeholder="Read-Only Input">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                        ...
                                                        <div class="x_panel">
                                                            ...
                                                            <div class="x_content">
                                                                <form class="form-horizontal form-label-left" id="crearform" enctype="multipart/form-data"> 
                                                                    ...
                                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Codigo </label>
                                                                    <div class="col-md-9 col-sm-9 col-xs-12" >
                                                                        <input type="text" id="idEgresado22" name="idEgresado22"  class="form-control" readonly="readonly"  value="<%=idEgresado%> ">
                                                                    </div>
                                                                </div>-->
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-6">Egresado</label>
                                                                        <div class="col-md-3 col-sm-3 col-xs-6">
                                                                            <input type="text" id="nombres" class="form-control" disabled="disabled" value="<%=egre.getNombres()%> <%=egre.getApellidos()%>">
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="x_content" id="tab3">
                                                                ...
                                                                <form id="crearformtab3" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group" id="id2">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12" >
                                                                            <input type="text" name="idEgresado3" id="idEgresado3" class="form-control" value="<%=idEgresado%>" readonly="readonly" placeholder="Read-Only Input">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="puesto" type="text" id="puesto" class="form-control" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Entidad</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="entidad" type="text" id="entidad" class="form-control" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="x_content">
                                                                <form class="form-horizontal form-label-left" id="crearform" enctype="multipart/form-data"> 
                                                                    <!-- <div class="form-group" id="id3">
                                                                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Codigo </label>
                                                                         <div class="col-md-9 col-sm-9 col-xs-12" >
                                                                             <input type="text" id="idEgresado33" name="idEgresado33"  class="form-control" readonly="readonly"  value="<%=egre.getIdEgresado()%> ">
                                                                         </div>
                                                                     </div>-->
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-6">Egresado</label>
                                                            ...
                                                            <div class="x_content" id="tab4">
                                                                ...
                                                                <form id="crearformtab4" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group" id="id2">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12" >
                                                                            <input type="text" name="idEgresado4" id="idEgresado4" class="form-control" value="<%=idEgresado%>" readonly="readonly" placeholder="Read-Only Input">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Mencion</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="mencion" id="mencion" type="text" class="form-control" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Institucion</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="institucion" id="institucion" type="text" class="form-control" value="">
                                                                        </div>
                                                                    </div>            
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Fecha Inicio</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="cantidad" id="cantidad" type="text" class="form-control" value="">
                                                                        </div>
                                                                    </div> 
                                                            ...
                                                            <div class="x_content">
                                                                <form class="form-horizontal form-label-left" id="crearform" enctype="multipart/form-data"> 
                                                                    <!-- <div class="form-group" id="id4">
                                                                         ...
                                                                         <div class="col-md-9 col-sm-9 col-xs-12" >
                                                                             <input type="text" id="idEgresado44" name="idEgresado44"  class="form-control" readonly="readonly"  value="<%=egre.getIdEgresado()%> ">
                                                                         </div>
                                                                     </div>-->
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-6">Egresado</label>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content5" aria-labelledby="profile-tab">
                                                    ...
                                                    <%
                                                      EstadisticaDAOFactory fabricate8 = new EstadisticaDAOFactory();
                                                      EstadisticaDAO daote8 = fabricate8.metodoDAO();

                                                      Estadistica estaegre = daote8.nro_preguntas_por_egresado(egre.getIdEgresado()); 
                                                        
                                                    if (estaegre.getValor()==32)
                                                    {                                                    
                                                    %>
                                                    <div class="col-md-6 col-xs-12">
                                                         <div class="x_panel">
                                                             
                                                                 <h2>Encuesta Realizada  </h2>      
                                                        ...
                                                        <div class="x_panel">
                                                            ...
                                                            <div class="x_content">
                                                                ...
                                                                <!-- start form for validation -->
                                                                    ...
                                                                    <input type="text" id="idEgresado5" name="idEgresado5" class="form-control" readonly="readonly"  value="<%=idEgresado%>">
            ...
            <script type="text/javascript">
             ...
             $('#SelectFacultad1').on('change', function () {
                        var codigo5 = this.value;
                    ...
                    table2 = $('#datatable-responsive2').DataTable({
                        ...
                        "columnDefs": [
                            ...
                            {"targets": -1,
                                "data": null,
                                "defaultContent": '<button name="btnVer2" data-toggle="tooltip" data-placement="left" title="VER GRADO OBTENIDO"><a><i class="fa fa-search"></i></a></button>&nbsp&nbsp<button name="btnEditar2" data-toggle="tooltip" data-placement="left" title="EDITAR"><a><i class="fa fa-pencil"></i></a></button>'}
                        ],
                        "ajax": "../GradoEgresadoController?accion=obtenerxidEgresado&codigo=" +<%=idEgresado%>,
                   ...
                   table2.on('order.dt search.dt', function () {
                    ...
                    $('#datatable-responsive2 tbody').on('click', 'button', function () {
                        ...
                        if (nombre2 == 'btnVer2') {
                            ...
                            mostrarModal('../JSPview/VerGrado.jsp?codigo=' + data2[0]+'&idEgresado='+<%=idEgresado%>);
                        }
                        if (nombre2 == 'btnEditar2') {

                            $('.modal-lg').css('width', '600px');
                            mostrarModal('../JSPmodify/ModGrado.jsp?codigo=' + data2[0]+'&idEgresado='+<%=idEgresado%>);
                        }
                    ...
                    table3 = $('#datatable-responsive3').DataTable({
                        ...
                        "columnDefs": [
                            ...
                            {"targets": -1,
                                "data": null,
                                "defaultContent": '<button name="btnVer3" data-toggle="tooltip" data-placement="left" title="VER TRABAJO"><a><i class="fa fa-search"></i></a></button>&nbsp&nbsp<button name="btnEditar3" data-toggle="tooltip" data-placement="left" title="EDITAR"><a><i class="fa fa-pencil"></i></a></button>'}
                        ],
                        "ajax": "../TrabajosController?accion=obtenerporidEgresado&codigo=" +<%=idEgresado%>,
                        "initComplete": function () {
                            $('[data-toggle="tooltip"]').tooltip({
                                trigger: 'hover',
                                html: true
                    ...
                    table4 = $('#datatable-responsive4').DataTable({
                        ...
                        "columnDefs": [
                            ...
                            {"targets": -1,
                                "data": null,
                                "defaultContent": '<button name="btnVer4" data-toggle="tooltip" data-placement="left" title="VER ESTUDIO REALIZADO"><a><i class="fa fa-search"></i></a></button>&nbsp&nbsp<button name="btnEditar4" data-toggle="tooltip" data-placement="left" title="EDITAR"><a><i class="fa fa-pencil"></i></a></button>'}
                        ],
                        "ajax": "../EstudiosController?accion=obetenerxEgresado&codigo=" +<%=idEgresado%>,
                        "initComplete": function () {
                            $('[data-toggle="tooltip"]').tooltip({
                                trigger: 'hover',
                                html: true
                    ...
                    $('#datatable-responsive4 tbody').on('click', 'button', function () {
                        ...
                        if (nombre4 == 'btnVer4') {
                            ...
                            $('.modal-lg').css('width', '600px');
                            mostrarModal('VerEstudio.jsp?codigo=' + data4[0]);
                        }
