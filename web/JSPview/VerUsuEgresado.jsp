...
<html>
    ...
    <%
        ...
        UsuarioEgresado   usu2=(UsuarioEgresado)session.getAttribute("sesion");
        Egresado objE = new Egresado();
        objE.setIdEgresado(usu2.getEgresado().getIdEgresado());
