...
$.getJSON('EstadisticaController?accion=pregunta_6', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: '',
                                    subtext: '¿Ha recibido reconocimiento profesional?',
                                    x: 'left'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_7', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: '',
                                    subtext: '¿Recomendaria a otras personas estudiar la misma carrera profesional que usted?',
                                    x: 'left'
                                },
                                tooltip: {
                                    trigger: 'item',
...
// -----------------------------------------2 ------------------------//
                 $.getJSON('EstadisticaController?accion=pregunta_2', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: '',
                                    subtext: '¿Hubo demora en obtener su grado de bachiller ?',
                                    x: 'left'
                                },
                                tooltip: {
                                    trigger: 'item',
...
// -----------------------------------------3 ------------------------//
                        $.getJSON('EstadisticaController?accion=pregunta_3', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: '',
                                    subtext: '¿Hubo demora en obtener su Titulo Profesional?',
                                    x: 'left'
                                },
                                tooltip: {
                                    trigger: 'item',
...
// -----------------------------------------4 ------------------------//
                        $.getJSON('EstadisticaController?accion=pregunta_4', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: '',
                                    subtext: '¿Usted esta conforme con la formacion que le brindo la universidad? ',
                                    x: 'left'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_5', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: '',
                                    subtext: '¿Cree que esta mejor preparado con respecto a egresados de otras universidades?',
                                    x: 'left'
                                },
                                tooltip: {
                                    trigger: 'item',
...
//--------------------------------------------8---------------------------------------
  $.getJSON('EstadisticaController?accion=pregunta_8', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'Que sugiere para mejorar la fomación profesional de la carrera profesional que usted estudios?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
//------------------------------------------------9-----------------------------
                        ...
                        $.getJSON('EstadisticaController?accion=pregunta_9', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria la formacion academica que recibio?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_10', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria la calidad de la plana docente?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_11', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria la estructura curricular?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_12', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria el nivel de exigencia academica?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_13', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria la metodologia de enzeñanza?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_14', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria la innovacion tecnologica?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_15', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria la infraestructura y ambientes?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_16', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria el servicio de biblioteca?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_17', function (json) {
                            ...
                            myChart.setOption({
                                title: {
                                    text: ' ',
                                    subtext: 'En su tiempo de estudio en la UNIA,¿Como calificaria los servicios (comedor, vivienda, etc)?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
