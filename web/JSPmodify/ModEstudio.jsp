                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select name="duracionacademica" id="duracionacademica" class="select2_single form-control" tabindex="-1">
                            ...
                            <option value="De s/.0.00 a s/.500">horas</option>
                            <option value="De s/.600 a s/.1000">dias</option>
                            <option value="De s/.1100 a s/.2000">meses</option>
                            <option value="De s/.2100 a s/2500">bimestre</option>
                            <option value="De s/.2100 a s/2500">trimestre</option>
                            <option value="De s/.2100 a s/2500">semestre</option>
                        </select>
                    </div>
