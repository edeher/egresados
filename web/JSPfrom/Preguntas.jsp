                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="" class="site_title"><i class="fa fa-male"></i> <span>Preguntas!</span></a>
                        </div>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    table = $('#datatable-responsive').DataTable({
                        ...
                        "ajax": "../PreguntaController?accion=obtenertodos",
                    ...
                    $('#datatable-responsive tbody').on('click', 'button', function () {
                        ...
                        var data = table.row($(this).parents('tr')).data();
                            ...
                            if (nombre == 'btnEditar') {
                                ...
                                mostrarModal('../JSPmodify/ModPregunta.jsp?codigo=' + data[0] );
                            }
                            if (nombre == 'btnEliminar') {

                                if (confirm("seguro que desea eliminar la Pregunta" ) == true)
                        {
                            $.ajax(
                                    {
                                        url: "../PreguntaController?accion=eliminar&idPregunta=" + data[0],
                                    }
                            )
                                    ...
                                    .always(function ()
                                    {
                                        ...
                                        alerta("Pregunta Eliminada", true);
                                    });
                ...
                $('#btnguardar').click(function () {
                    ...
                    $.ajax({
                        url: "../PreguntaController?accion=crear",
                        type: "post",
                        contentType: false,
                        data: formdata,
                        processData: false,
                        cache: false})
                            .done(function (id) {
                                ...
                                if (id == 0) {
                                    ...
                                    alerta("Pregunta no creada", false);
                                } else
                                {
                                    actualizartabla(table);
                                    alerta("Pregunta creada", true);
                                    $('#idEncuesta').val('--');
                                    $('#tipopregunta').val('--');
                                    $('#descripcion').val("");
                                    $('#tab').css('display', 'none');
