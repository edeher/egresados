                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-8 col-xs-12">
                             ...
                             <div class="col-md-6 col-sm-8 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>14.-En su opinion ¿que posibilidades laborales tiene el egresado d ela UNIA para desempeñarse en su especialidad?</h2>
...
// -------------------------------19_2-------------------------////////////////////
                        ...
                        $.getJSON('EstadisticaController?accion=pregunta_19_2', function (json) {
                            ...
                            myChart.setOption({
                                  title: {
                                    text: ' ',
                                    subtext: 'A partir de sus experiencia laboral ¿la formacion profesional que recibio es?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
//-------------------------------------------------20_3-----------------------------------------------
                        ...
                        $.getJSON('EstadisticaController?accion=pregunta_20_3', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: '¿Actualmente su trabajo esta relacionado con la carrera profesional que estudio?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
//-------------------------------------------21_4--------------------------------------  
           $.getJSON('EstadisticaController?accion=pregunta_21_4', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: 'Con respecto a las Labores que viene realizando en su empleo actual ¿usted se siente?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
//-------------------------------------------22_5--------------------------------------  
           $.getJSON('EstadisticaController?accion=pregunta_22_5', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: 'Considera que su remuneracion como profesional',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_23_6', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: 'Si unca trabajo en su carrera profesional ¿Por que?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_24_7', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: '¿Encontro trabajo en el año que egreso?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_25_8', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: '¿Encontro trabajo el año que obtubo su bachiller?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_26_9', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: '¿Encontro trabajo el año que obtubo su titulo?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_27_10', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: 'Al buscar su primer trabajo ¿que tiempo demoro?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_28_11', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: 'El puesto que ocupo en su primer trabajo ¿fue?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_29_12', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: 'Su desempeño en su primer trabajo ¿fue?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_30_13', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: '¿Que competencias o habilidades obtenidas han favorecido mas en su ejerecicio profesional?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
$.getJSON('EstadisticaController?accion=pregunta_31_14', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: 'En su opinion ¿que posibilidades laborales tiene el egresado d ela UNIA para desempeñarse en su especialidad?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
...
//-------------------------------------------32_15--------------------------------------   
 $.getJSON('EstadisticaController?accion=pregunta_32_15', function (json) {
                            ...
                            myChart.setOption({
                             title: {
                                    text: ' ',
                                    subtext: 'En su opnion ¿como califica su desempeño profesional en su trabajo?',
                                    x: 'LEFT'
                                },
                                tooltip: {
                                    trigger: 'item',
